# -*- coding: utf-8 -*-
"""
Created on Sun May  5 16:03:33 2019
...
dt = pd.read_csv("us.1970.singleages.adjusted.txt",names=['Data']) #,skiprows=1319460)
...
merged = merged[(merged['year']== 1970)&(merged['state'] != 'AK')&(merged['state'] != 'HI')]
